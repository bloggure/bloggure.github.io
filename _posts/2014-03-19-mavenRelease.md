...
Souvent un des freins à la libre distribution de ces sources très utiles n'est pas la mise à disposition des sources ([Github](http://www.github.com/Cedric_Gatay) a bien aidé dans ce sens ces dernières années), mais la distribution sur un des dépôts Maven accessible au tout venant.
